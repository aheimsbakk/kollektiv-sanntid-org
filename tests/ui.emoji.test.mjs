...
assertEqual(node1.container.querySelector('.departure-emoji').textContent, '🚌', 'bus emoji');
...
assertEqual(node2.container.querySelector('.departure-emoji').textContent, '🚋', 'tram emoji');
...
assertEqual(node3.container.querySelector('.departure-emoji').textContent, '🚆', 'fallback emoji');

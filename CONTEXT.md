Overall Context: Kollektiv.Sanntid.org - Real-time Norwegian public transport departure board. Version 1.40.18.
...
- Version bump to v1.40.18: synchronized src/config.js, src/sw.js, and package.json after local config.js update
